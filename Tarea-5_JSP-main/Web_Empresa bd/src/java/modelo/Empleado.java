...
public class Empleado extends Persona {
    ...
    try{
     ...
     cn.abrir_conexion();
     String query= "SELECT e.id_empleados as id, e.codigo, e.nombres, e.apellidos, e.direccion, e.telefono, e.fecha_nacimiento, p.puesto, p.id_puestos FROM empleados as e inner join puestos as p on e.id_puesto=p.id_puestos;";
     ResultSet consulta = cn.conexionBD.createStatement().executeQuery(query);
     
     String encabezado[]= {"id","codigo", "nombres", "apellidos", "direccion", "telefono", "fecha nacimiento", "puesto", "idpuesto"};
